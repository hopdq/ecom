...
INSERT INTO `ProductAttrValue` VALUES ('1','11'),('3','11');
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE PROCEDURE `productAttributes_Get4ProductManager`(in productId varchar(20))
BEGIN
	select
	av.Id,
	av.AttributeId,
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE PROCEDURE `productAttributeValue_InsertUpdate`(in productId varchar(20), in attrIdList varchar(1000))
BEGIN
	declare Cnt int;
	declare maxCnt int;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE PROCEDURE `productImage_InsertUpdate`(in productId varchar(20), in imageIds varchar(1000), in imgDefaultId varchar(20))
BEGIN
	declare Cnt int;
	declare maxCnt int;
	DROP temporary TABLE IF EXISTS TmpTable;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE PROCEDURE `Product_GetAll_Paging`(in keyword varchar(250), in cateId varchar(20), in status varchar(20), in pageNumber int, in pageSize int)
BEGIN
...
-- Dump completed on 2015-10-12 23:20:41
